...
import (
	...
	pipelinev1alpha1 "github.com/chengjoey/pipelines/pkg/apis/pipeline/v1alpha1"
	versioned "github.com/chengjoey/pipelines/pkg/client/clientset/versioned"
	internalinterfaces "github.com/chengjoey/pipelines/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/chengjoey/pipelines/pkg/client/listers/pipeline/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ZchengjoeyV1alpha1().PipelineRuns(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ZchengjoeyV1alpha1().PipelineRuns(namespace).Watch(context.TODO(), options)
			},
		},
