...
import (
	...
	scheme "github.com/chengjoey/pipelines/pkg/client/clientset/versioned/scheme"
...
func newPipelineRuns(c *ZchengjoeyV1alpha1Client, namespace string) *pipelineRuns {
	return &pipelineRuns{
		client: c.RESTClient(),
		ns:     namespace,
	}
