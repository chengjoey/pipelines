...
var tasksResource = schema.GroupVersionResource{Group: "zchengjoey.dev", Version: "v1alpha1", Resource: "tasks"}

var tasksKind = schema.GroupVersionKind{Group: "zchengjoey.dev", Version: "v1alpha1", Kind: "Task"}
