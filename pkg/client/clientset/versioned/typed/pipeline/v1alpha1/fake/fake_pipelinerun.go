...
type FakePipelineRuns struct {
	Fake *FakeZchengjoeyV1alpha1
	ns   string
}

var pipelinerunsResource = schema.GroupVersionResource{Group: "zchengjoey.dev", Version: "v1alpha1", Resource: "pipelineruns"}

var pipelinerunsKind = schema.GroupVersionKind{Group: "zchengjoey.dev", Version: "v1alpha1", Kind: "PipelineRun"}
