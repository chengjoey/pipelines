...
var pipelinesResource = schema.GroupVersionResource{Group: "zchengjoey.dev", Version: "v1alpha1", Resource: "pipelines"}

var pipelinesKind = schema.GroupVersionKind{Group: "zchengjoey.dev", Version: "v1alpha1", Kind: "Pipeline"}
