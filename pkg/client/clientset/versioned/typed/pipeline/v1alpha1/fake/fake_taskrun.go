...
var taskrunsResource = schema.GroupVersionResource{Group: "zchengjoey.dev", Version: "v1alpha1", Resource: "taskruns"}

var taskrunsKind = schema.GroupVersionKind{Group: "zchengjoey.dev", Version: "v1alpha1", Kind: "TaskRun"}
