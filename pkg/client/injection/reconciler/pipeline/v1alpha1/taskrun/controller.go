...
import (
	...
	taskrun "github.com/chengjoey/pipelines/pkg/client/injection/informers/pipeline/v1alpha1/taskrun"
	zap "go.uber.org/zap"
...
const (
	...
	defaultFinalizerName       = "taskruns.zchengjoey.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "zchengjoey.dev.TaskRun"),
	)
