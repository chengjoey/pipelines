...
import (
	...
	pipeline "github.com/chengjoey/pipelines/pkg/client/injection/informers/pipeline/v1alpha1/pipeline"
	zap "go.uber.org/zap"
...
const (
	...
	defaultFinalizerName       = "pipelines.zchengjoey.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "zchengjoey.dev.Pipeline"),
	)
