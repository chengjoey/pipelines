...
// controller reconciling v1alpha1.Task.
type Interface interface {
	// ReconcileKind implements custom logic to reconcile v1alpha1.Task. Any changes
	// to the objects .Status or .Finalizers will be propagated to the stored
	// object. It is recommended that implementors do not call any update calls
	// for the Kind inside of ReconcileKind, it is the responsibility of the calling
	// controller to propagate those properties. The resource passed to ReconcileKind
	// will always have an empty deletion timestamp.
	ReconcileKind(ctx context.Context, o *v1alpha1.Task) reconciler.Event
}

// Finalizer defines the strongly typed interfaces to be implemented by a
// controller finalizing v1alpha1.Task.
type Finalizer interface {
	// FinalizeKind implements custom logic to finalize v1alpha1.Task. Any changes
	...
	// deletion timestamp.
	FinalizeKind(ctx context.Context, o *v1alpha1.Task) reconciler.Event
}

// ReadOnlyInterface defines the strongly typed interfaces to be implemented by a
// controller reconciling v1alpha1.Task if they want to process resources for which
// they are not the leader.
type ReadOnlyInterface interface {
	// ObserveKind implements logic to observe v1alpha1.Task.
	// This method should not write to the API.
	ObserveKind(ctx context.Context, o *v1alpha1.Task) reconciler.Event
}

type doReconcile func(ctx context.Context, o *v1alpha1.Task) reconciler.Event

// reconcilerImpl implements controller.Reconciler for v1alpha1.Task resources.
type reconcilerImpl struct {
	...
	Lister pipelinev1alpha1.TaskLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister pipelinev1alpha1.TaskLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.Task) (*v1alpha1.Task, error) {
	...
	patcher := r.Client.ZchengjoeyV1alpha1().Tasks(resource.Namespace)
...
func (r *reconcilerImpl) setFinalizerIfFinalizer(ctx context.Context, resource *v1alpha1.Task) (*v1alpha1.Task, error) {
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1alpha1.Task, reconcileEvent reconciler.Event) (*v1alpha1.Task, error) {
	if _, ok := r.reconciler.(Finalizer); !ok {
		return resource, nil
	}
	if resource.GetDeletionTimestamp().IsZero() {
