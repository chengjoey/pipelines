...
import (
	...
	versionedscheme "github.com/chengjoey/pipelines/pkg/client/clientset/versioned/scheme"
	client "github.com/chengjoey/pipelines/pkg/client/injection/client"
	pipelinerun "github.com/chengjoey/pipelines/pkg/client/injection/informers/pipeline/v1alpha1/pipelinerun"
	zap "go.uber.org/zap"
...
const (
	...
	defaultFinalizerName       = "pipelineruns.zchengjoey.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "zchengjoey.dev.PipelineRun"),
	)
